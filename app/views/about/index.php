                    ...
                    <div class="error-page">
                        ...
                        <div id="ctl29_error404" class="error-page__message dk-box">
                            ...
                            <img class="error-page__message--logo"
                                 style="margin: 20px;width: 24%;"
                                 src="public/images/pixel-perfect-final-v02-01.png"
                                 alt="digikala error page"/>

                            <p style="margin: 10px;font-size: 14px;line-height: 30px;color: #fff" class="error-page__guide-text">لورم ایپسوم متن
                                ...
                                شرایط سخت تایپ به پایان رسد وزمان مورد نیاز شامل حروفچینی دستاوردهای اصلی و جوابگوی
