...
<head>
    ...
    <title><?= NAME; ?> | افزودن نشریه جدید</title>
    <!-- Favicon -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            <h3 class="box-title">افزودن نشریه جدید</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="box-body">
                                <div class='row'>
                                    ...
                                    <div class='col-md-5'>
                                        <div class="form-group" style="text-align:right">
                                            <label align="right" for="titleNews">:عنوان نشریه</label>
...
<script>
    $("#btnsubmit").on('click', function () {
        ...
        if (titleNews == "") {
            generate('warning', '<div class="activity-item" style="text-align:right" dir="rtl">عنوان نشریه را وارد کنید.</div>');
        } else if (linkNews == "") {
            ...
            $.ajax({
                    url: "adminpanel/addMags",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function (data) {
                        generate('success', '<div class="activity-item" style="text-align:right" dir="rtl">نشریه جدید باموفقیت ثبت شد.</div>');
                        window.location.href = 'adminpanel/news/magsSource';
                    }
                }
            );
        }
