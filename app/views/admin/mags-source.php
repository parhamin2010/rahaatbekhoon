    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?= URL; ?>adminpanel/mags/magsSource"><i class="fa fa-clone"></i> Sources</a></li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">مدیریت نشریات</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <table id="example1" class="table direction table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align:center">عنوان نشریه</th>
