            ...
            <div class="topics wrapper" style="transform: none;margin-bottom: 40px;">
                            ...
                            <div style="color: #9ba4ab;float: left;">
                                                <span class="social-networks">
                                                         ...
                                                         <a class="icon-g-plus" rel="nofollow"
                                                            href="https://plus.google.com/share?url=<?= URL ?>blog/<?= $news[0]['n_id'] ?>"
                                                            target="_blank">
                                                         </a>

                                                         <a class="icon-twitter" rel="nofollow"
                                                            href="http://twitter.com/intent/tweet/?text=<?= $news[0]['title'] ?>&amp;url=<?= URL ?>blog/<?= $news[0]['n_id'] ?>"
                                                            target="_blank">
                                                         </a>

                                                         <a class="icon-fb" rel="nofollow"
                                                            href="http://www.facebook.com/sharer/sharer.php?m2w&amp;s=100&amp;p[url]=<?= URL ?>blog/<?= $news[0]['n_id'] ?>&amp;p[images][0]=<?= URL ?>public/images/news/<?= $news[0]['i_image'] ?>&amp;p[title]=<?= $news[0]['title'] ?>&amp;p[summary]=<?= $news[0]['subtitle'] ?>"
                                                            target="_blank">
                                                         </a>

                                                         <a class="icon-linkedin" rel="nofollow"
                                                            href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?= URL ?>blog/<?= $news[0]['n_id'] ?>&amp;title=<?= $news[0]['title'] ?>&amp;source=<?= URL ?>"
                                                            target="_blank">
                                                         </a>
                                                   </span>
                            </div>
				...
				<label class="cptch_label" for="cptch_input_94"><span class="cptch_span">
					...
					<span class="cptch_reload_button dashicons dashicons-update"></span>
                                        ...
                                        <p class="form-submit"><input style="border:0" name="submit" type="submit"
                                                                      id="submit-comment"
                                                                      class="comment-submit-btn" value="ارسال دیدگاه">
                                            <input style="border:0" type="hidden" name="comment_post_ID" value="368348"
                                                   id="comment_post_ID">
                        ...
                        <a rel="nofollow" class="comment-reply-link"
                           ...
                           aria-label="پاسخ به سعید"><i class="icon-reply-arrow"></i></a>
                                                ...
                                                <div class="_item__comment">
                                                    <p>عجیبه که تعبیر شما از کلمه Boring در اسم این شرکت به صورت خسته
                                                        بوده! در اینجا به معنی حفاری هست… چه ربطی به خسته داره
                                                        آخه…؟!!</p>
                                                </div>
                                                ...
                                                <li class="comment byuser comment-author-amir-mirzaee bypostauthor odd alt depth-2 single-comment _item _person"
                                                    ...
                                                    <div id="comment-201498" class="comment-body">
                                                        ...
                                                        <div class="_item__user comment-meta post-author">
                                                            <img src="public/DigiWeb_files/Default_Profile_Picture1.jpg"
                                                                 width="35" height="35" alt="امیرحسین میرزایی"
                    ...
                    <time datetime="۱۳۹۶-۱۱-۹ ۱۲:۲۷:۵۰ +۰۳:۳۰" class="_date">۹ بهمن ۱۳۹۶  |  ۱۲:۲۷</time>
                                                            ...
                                                            if ($UserID == true) {
                                                                ...
                                                                <span class="_btn">
                        <a rel="nofollow" class="comment-reply-link"
                           href="blog/6/?replytocom=201498#respond"
                           ...
                           aria-label="پاسخ به امیرحسین میرزایی"><i class="icon-reply-arrow"></i></a>                    </span>
                                                        ...
                                                        <div class="_item__comment">
                                                            <p>اسم اساسا نباید ترجمه بشه و ما هم The Boring Company رو
                                                                ترجمه نکرده و به صورت اصلی در متن کار کرده‌ایم.<br>
                                                                منظور از «شرکت خسته»، شوخی با ایلان ماسک و ایهام در
                                    ...
                                    foreach ($news as $newsInfo) {
                                        ...
                                        <li class="related-posts__item">
                                            <a href="blog/<?= $newsInfo['n_id']; ?>"
                                               ...
                                               class="image-wrapper">
                                                <img src="public/images/news/<?= $newsInfo['i_image']; ?>" width="60"
                                                     height="60" class="image-wrapper__img wp-post-image"
                                                     style="border-radius:3px"
                                                     alt="<?= $newsInfo['title']; ?>" data-lazy-loaded="true"> </a>
