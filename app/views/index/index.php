                                        ...
                                        <a href="news/<?= $newsVipInfo['n_id'] ?>"
                                           class="carousel__body__item" title="<?= $newsVipInfo['title'] ?>">
                                            ...
                                            <span class="item__details">
                                                <i class="icon-news"></i>
                                                <span class="item__details--author"><?= $newsVipInfo['sourceName'] ?></span>
                                                <i class="icon-clock-icon"></i>
                                                <time datetime="<?= $newsVipInfo['date_created'] ?>" class="item__details--date"><?= $newsVipInfo['date_created'] ?></time>
                                            </span>
                                        </a>
                                        <?php
                                    }
